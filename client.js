...
const functions = {
  ...
  async getCourse() {
    const response = await fetch(baseUrl + "/lms/course/html-e-css");
    const body = await response.json();
    console.log(body);
  },
  ...
  async getLesson() {
    const response = await fetch(
      baseUrl + "/lms/lesson/html-e-css/estrutura-do-documento",
    );
    const body = await response.json();
    console.log(body);
  },
  ...
  async completeLesson() {
    const response = await fetch(baseUrl + "/lms/lesson/complete", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        courseId: 1,
  ...
  async resetCourse() {
    const response = await fetch(baseUrl + "/lms/course/reset", {
      method: "DELETE",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        courseId: 1,
